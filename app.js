...
function extractDayStateFromParsed(parsed) {
  ...
  return {
    ...
    ui: {
      ...
      progressOpen: typeof ui.progressOpen === 'boolean' ? ui.progressOpen : true,
...
function updateProgressVisibility() {
  ...
  uiFields.progressToggle.textContent = state.ui.progressOpen ? 'Ocultar registro diario' : 'Mostrar registro diario';
}
